    ...
    <div class="container">
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            <h2 class="ftco-heading-2"><a href="#" class="logo">GM<span>Automobili</span></a></h2>
            <p>Lorem ipsum dolored is a sit ameted consectetur adipisicing elit...</p>
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <div class="block-23 mb-3">
              <ul>
                <li><span class="icon icon-map-marker"></span><span class="text">S.p 215, 70010 - Turi (BA)</span></li>
      ...
      <div class="row">
        <div class="col-md-12 text-center">
          <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> GM Automobili | <a href="/privacy-policy" target="_blank">Privacy & Cookie Policy</a> | <a href="/sitemap" target="_blank">Sitemap</a></p>
        </div>
      </div>
    </div>
  </footer>
