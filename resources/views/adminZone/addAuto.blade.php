                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="targaVeicolo" class="bmd-label-floating">Targa Auto</label>
                                <input class="form-control" type="text" name="targaVeicolo" required="true" aria-required="true">
                            </div>
                            <div class="form-group">
                                <label for="vinVeicolo" class="bmd-label-floating">Vin Auto</label>
                                <input class="form-control" type="text" name="vinVeicolo" required="true" aria-required="true">
                            </div>
                            <div class="form-group">
                                <label for="categoriaVeicolo" class="bmd-label-floating">Categoria Veicolo</label>
                            ...
                            <div class="form-group">
                                <label for="meseImmatricolazione" class="bmd-label-floating">Mese Immatricolazione</label>
                            ...
                            <div class="form-group">
                                <label for="AnnoImmatricolazione" class="bmd-label-floating">Anno Immatricolazione</label>
                                <input class="form-control" type="number" name="AnnoImmatricolazione" min="1900" required="true" aria-required="true">
                            </div>
                            <div class="form-group">
                                <label for="produttoreVeicolo" class="bmd-label-floating">Produttore Veicolo</label>
                            ...
                            <div class="form-group">
                                <label for="modelloVeicolo" class="bmd-label-floating">Modello Veicolo</label>
                            ...
                            <div class="form-group">
                                <label for="allestimentoVeicolo" class="bmd-label-floating">Allestimento Veicolo</label>
                                <input class="form-control" type="text" name="allestimentoVeicolo" required="true" aria-required="true">
                            </div>
                            <div class="form-group">
                                <label for="kmVeicolo" class="bmd-label-floating">Chilometraggio (km)</label>
                ...
                <div class="col-12 col-md-6 order-0 order-md-1">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="titoloAnnuncio" class="bmd-label-floating">Titolo Annuncio</label>
                                <input class="form-control" type="text" name="titoloAnnuncio" required="true" aria-required="true">
                            </div>
                            <div class="form-group">
                                <label for="testoAnnuncio" class="bmd-label-floating">Testo dell'annuncio</label>
                                <input class="form-control" type="text" name="testoAnnuncio" required="true" aria-required="true">
                            </div>
                            <div class="form-group">
                                <label for="prezzoVeicolo" class="bmd-label-floating">Prezzo</label>
                            ...
                            <div class="form-group">
                                <label for="carburanteVeicolo" class="bmd-label-floating">Carburante Veicolo</label>
                            ...
                            <div class="form-group">
                                <label for="coloreVeicolo" class="bmd-label-floating">Colore Veicolo</label>
                            ...
                            <div class="form-group">
                                <label for="cambioVeicolo" class="bmd-label-floating">Cambio Veicolo</label>
                            ...
                            <div class="form-group">
                                <label for="classeVeicolo" class="bmd-label-floating">Classe emissioni Veicolo</label>
                            ...
                            <div class="form-group">
                                <label for="postiVeicolo" class="bmd-label-floating">Posti Veicolo</label>
                            ...
                            <div class="form-group">
                                <label for="porteVeicolo" class="bmd-label-floating">Porte Veicolo</label>
